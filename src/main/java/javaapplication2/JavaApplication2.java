...
public class Lanchonete {
	...
	private String[] ingredientes = new String[500];// armazena o nome dos ingredientes
	private double[] precos = new double[500];// armazena o preço dos ingredientes
